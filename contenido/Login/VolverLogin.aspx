<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VolverLogin.aspx.cs" Inherits="contenido_Login_VolverLogin" %>
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                <div class="card-header">
				    <h3 id="id" runat="server">SOFYA</h3>
                    <asp:Label ID="lblTit" runat="server"></asp:Label>
                </div>
                <div class="card-body">
				<form id="form1" runat="server">
					<div class="form-group">
                        <asp:Button ID="Ingresar" runat="server" Text="Ir a Login" class="btn float-right login_btn" OnClick="Ingresar_Click" />
					</div>
				</form>
			</div>
            </div>
