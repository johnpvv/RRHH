                    ...
                    <table border="0" style="width: 100%" >
                      ...
                      <tr>
                        ...
                        <td class="auto-style4">
                            <asp:TextBox ID="TID"  onkeypress="KeyEnter(event)" runat="server" MaxLength="5" style="text-transform:uppercase;" ></asp:TextBox>
                      ...
                      <tr>
                        ...
                        <td class="TextoLeft">
                            <asp:TextBox ID="TServicio" runat="server"  onkeypress="KeyEnter(event)" MaxLength="100" style="text-transform:uppercase;"></asp:TextBox>
                ...
                <ContentTemplate>            
                        ...
                        <asp:GridView ID="dgData" runat="server" DataKeyNames="CODUNIOP" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="UNIDAD_SUPERIOR" HeaderText="UNIDAD SUPERIOR" >
                                <HeaderStyle CssClass="Titulo2" />
                                <ItemStyle Width="50px" CssClass="TextoCenter" Font-Size="8pt" />
                                </asp:BoundField>                                                              
