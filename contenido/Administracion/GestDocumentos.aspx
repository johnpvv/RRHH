<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GestDocumentos.aspx.cs" Inherits="contenido_Administracion_GestDocumentos" %>
...
<body>
    ...
    <div align="center">
            ...
            <td class="auto-style2">
                    <table width="100%" border="0">
                      <tr>
                        ...
                        <table width="100%" border="0" class="TextoLeft"><tr><td 
                        >&nbsp;</td><td class="style31"><label></label></td>
                            <td class="style31">
                                &nbsp;</td>
                            <td class="style31">
                                &nbsp;</td>
                            </tr><tr><td class="TextoRigth">Archivo:</td><td class="style30">
                                ...
                                <td class="style30">
                                    <asp:DropDownList ID="ddltipodoc" runat="server">
                                        <asp:ListItem Selected="True" Value="0">Seleccionar Tipo</asp:ListItem>
                                        <asp:ListItem Value="1">Manual</asp:ListItem>
                                        <asp:ListItem Value="2">Certificado</asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr><tr><td class="style4">&nbsp;</td><td class="style31">&nbsp;</td>
                                <td class="style31">
                                    &nbsp;</td>
                                <td class="style31">
                                    &nbsp;</td>
                    ...
                    <table border="0" style="width: 100%" >
                      ...
                      <tr>
                        ...
                        <td class="TextoLeft">
                            <asp:TextBox ID="TDoc" runat="server" MaxLength="100" Width="384px" ></asp:TextBox>

                          </td>
                        <td class="style6">
                            <asp:ImageButton ID="ImBtIngresar" runat="server" Height="30px" 
                                ImageUrl="~/imagenes/check.png" 
                                Width="45px" onclick="BtAgregarPr_Click" />
        ...
        <hr />
                        ...
                        <asp:GridView ID="dgData" runat="server" DataKeyNames="IDDOC" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="IDDOC" HeaderText="ID" ReadOnly="true" >
                                ...
                                <asp:BoundField DataField="F_H_CREACION" HeaderText="F_H_CREACION" ReadOnly="true" >
                                <HeaderStyle CssClass="Titulo2" />
                                <ItemStyle Width="50px" CssClass="TextoCenter" Font-Size="8pt" />
                                </asp:BoundField>                                                              
                                                             
                                <asp:BoundField DataField="TIPODOC" HeaderText="TIPODOC" ReadOnly="true" >
                                <HeaderStyle CssClass="Titulo2" />
                                <ItemStyle Width="50px" CssClass="TextoCenter" Font-Size="8pt" />
                                </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Ver">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btn_Upload" runat="server" ImageUrl="~/imagenes/eye-icon.png"  
                                        OnClick="UploadDoc" />
                                </ItemTemplate>
                                <HeaderStyle CssClass="Titulo2" Width="50px" />
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
