<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GestionPacientes.aspx.cs" Inherits="contenido_SysAdmin_GestionPacientes" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ajaxToolkit:TabContainer runat="server" ID="TC_1" Height="500px" Width="800px"
            ...
            <ajaxToolkit:TabPanel runat="server" ID="TabPanel4" HeaderText="Prueba4" Font-Names="Tahoma" ForeColor="#666666" Font-Size="13px">
                <HeaderTemplate>Detalle Pacientes</HeaderTemplate>
                <ContentTemplate>
                        ...
                        <tr>
                            <td class="auto-style52">
                                ...
                                <table border="0" style="width: 650px">
                                    <tr>
                                        <td class="auto-style56">Programar</td>
                                        <td class="TextoLeft">
                            ...
                            <asp:TextBox ID="TxtDvT" runat="server" MaxLength="1" Width="23px"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td class="auto-style56">Nombres:</td>
                                        <td class="TextoLeft">
                                    ...
                                    <tr>
                                        <td class="auto-style56">Nombre Social:</td>
                                        <td class="TextoLeft">
                                    ...
                                    <tr>
                                        <td class="auto-style56">Apellido Paterno:</td>
                                        <td class="TextoLeft">
                                    ...
                                    <tr>
                                        <td class="auto-style56">Apellido Materno:</td>
                                        <td class="TextoLeft">
                                    ...
                                    <tr>
                                        <td class="auto-style56">Dirección:</td>
                                        <td class="TextoLeft">
                                    ...
                                    <tr>
                                        <td class="auto-style56">Prevision:</td>
                                        <td class="TextoLeft">

                                            <ajaxToolkit:ListSearchExtender ID="ListSearchExtender2" runat="server" Enabled="True" PromptCssClass="PromptCSS" QueryPattern="Contains" TargetControlID="ddlPrevision">
                                    ...
                                    <tr>
                                        <td class="auto-style56">Región:</td>
                                    ...
                                    <tr>
                                        <td class="auto-style56">Comuna:</td>
                                ...
                                <table border="0" class="auto-style6">
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style63">-<asp:HiddenField ID="hdIdentificador" runat="server" />
                                        </td>
            ...
            <ajaxToolkit:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel2">
                <HeaderTemplate>Recetas Emitidas</HeaderTemplate>
            </ajaxToolkit:TabPanel>
