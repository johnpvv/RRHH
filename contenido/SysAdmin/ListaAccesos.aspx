...
<body>
    <form id="form1" runat="server">
         ...
         <table width="90%" border="1">
            ...
            <td class="auto-style4">
                    ...
                    <table border="0" style="width: 801px" >
                      ...
                      <tr>
                        <td class="TextoRigth">Acceso:</td>
                        <td class="TextoLeft" colspan="4">
                            <asp:TextBox ID="TxtAcceso" runat="server" Width="455px"></asp:TextBox>
                          </td>
                        <td>&nbsp;</td>
                        <td class="auto-style3">&nbsp;</td>
                      </tr>
        ...
        <hr />
             ...
             AutoGenerateColumns="False" DataKeyNames="idapp" 
             ...
             AllowPaging="True" onpageindexchanging="dgData_PageIndexChanging" PageSize="20" AllowSorting="True">
                            <Columns>
                                <asp:BoundField DataField="idapp" HeaderText="Id" ShowHeader="False" 
                                ...
                                <asp:BoundField DataField="num_usr" HeaderText="num_usr" SortExpression="num_usr">
                                <HeaderStyle CssClass="Titulo2" />
                                <ItemStyle Width="70px" CssClass="TextoCenter" />
                                </asp:BoundField>
                                

                                <asp:BoundField DataField="num_rol" HeaderText="num_rol" SortExpression="num_rol">
                                <HeaderStyle CssClass="Titulo2" />
                                <ItemStyle Width="70px" CssClass="TextoCenter" />
                                </asp:BoundField>
