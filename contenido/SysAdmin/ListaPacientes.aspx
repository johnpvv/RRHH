<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListaPacientes.aspx.cs" Inherits="contenido_SysAdmin_ListaPacientes" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="90%" border="1" class="table table-hover table-bordered">
            <tr>
                <td>
