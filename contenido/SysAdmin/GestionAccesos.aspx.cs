...
public partial class contenido_SysAdmin_GestionAccesos : System.Web.UI.Page
{
    ...
    private void mfCargaGrp()
    {
        ...
        aoDs = acs.jaxListaRoles(Session["codHosp"].ToString(), Session["lsIdentificador"].ToString());
    ...
    private void mfCargaGrpDisp()
    {
        ...
        aoDs = acs.jaxListaRolesDisp(Session["codHosp"].ToString(), Session["lsIdentificador"].ToString());
